...
export const UpArrow = ({color, width, height} : SVGProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="currentColor" height={height} width={width} version="1.1" id="Layer_1" viewBox="0 0 511.735 511.735" xmlSpace="preserve">
        <g>
            <g>
